		...
		<div class="">
			...
			<article id="main" class="special">
				<header>
					...
					<h2 class="zapfiro text-shadow" style="font-size: 300%; margin-top: -8%; margin-bottom: -2%;">Username</h2>
					<br>
					...
					<br>
					<br>
					<h2 class="zapfiro text-shadow" style="font-size: 300%; margin-top: -8%; margin-bottom: -2%;">Password</h2>
					<br>
